...
var dbConnection;
var tableNames = ['QuestionTags', 'Tags', 'Questions'];
...
db.Question.createNewQuestion('exampleUser', 'firstQuestion', '', 20, '')
  .then(() => {
    return db.Question.createNewQuestion('exampleUser', 'secondQuestion', '', 20, '');
  })
  .then((question) => {
    var tags = ['react', 'es6'];
